...
param (
    ...
    [string[]]$Urls = @(
        "https://regions.udot.utah.gov/server/rest/services",
        "https://regions.udot.utah.gov/arcgis/rest/services"
    ),
    ...
    [Parameter()]
    [ValidateNotNullOrEmpty()]
    [string]$LogPath = "D:\PowerShell\regions_portal_connectivity\logs\IIS-HealthMonitor.log"
