...
param (
    ...
    [string[]]$Urls = @(
        ...
        "https://central.udot.utah.gov/server/rest/services",
        "https://central.udot.utah.gov/image/rest/services",
        "https://central.udot.utah.gov/maint/rest/services",
        "https://central.udot.utah.gov/row/rest/services"
    ),
